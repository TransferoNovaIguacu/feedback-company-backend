...
from missions.models import Mission, Feedback, QuizAnswer
...
class BaseTestCase(APITestCase):
    def setUp(self):
        ...
        self.plan = ContractedPlan.objects.create(
            ...
            # start_date=timezone.now().date(),  # Remova se não existir
            # end_date=(timezone.now() + timedelta(days=30)).date(),  # Remova se não existir
